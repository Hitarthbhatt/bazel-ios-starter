...
_SETTINGS = {
    "arm64-apple-ios-simulator NewApp.app/NewApp": {
        "c": "-iquote$(PROJECT_DIR) -iquote$(BAZEL_OUT)/ios_sim_arm64-dbg-ios-sim_arm64-min17.0-applebin_ios-ST-1d00ae144680/bin -O0 -DDEBUG=1 -fstack-protector -fstack-protector-all",
    },
}
